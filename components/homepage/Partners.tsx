    ...
    <section className="relative py-20 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 relative">
        <div className="text-center mb-16">
          ...
          <div className="w-20 h-1 bg-[#40e0d0]/20 mx-auto mt-4 rounded-full" />
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-stretch">
          ...
          <div className="flex flex-col h-full">
            <div className="bg-white rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 flex-1 flex flex-col">
              ...
              <div className="relative aspect-[4/3] bg-[#003366] rounded-xl overflow-hidden shadow-lg group flex-shrink-0">
                {/* Background Pattern */}
                    ...
                    <div className="absolute inset-0">
                      ...
                      <div className="absolute top-[55%] left-[48%] transform -translate-x-1/2 -translate-y-1/2">
                        <div className="relative">
                          <div className="w-6 h-6 rotate-45 bg-[#40e0d0]/30 rounded-sm">
                      ...
                      <div className="absolute top-[65%] left-[68%] transform -translate-x-1/2 -translate-y-1/2">
                        <div className="w-4 h-4 rotate-45 bg-[#40e0d0]/20 rounded-sm">
                          <div className="absolute inset-0 flex items-center justify-center -rotate-45">
                      ...
                      <svg className="absolute inset-0 w-full h-full">
                        <line x1="48%" y1="55%" x2="68%" y2="65%" stroke="#40e0d0" strokeOpacity="0.2" strokeWidth="1.5" />
                        <line x1="48%" y1="55%" x2="28%" y2="45%" stroke="#40e0d0" strokeOpacity="0.2" strokeWidth="1.5" />
                      </svg>
                    </div>
                  </div>
                </div>
                ...
                <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-[#003366]/50">
                  <div className="text-center space-y-3">
                    <div className="flex items-center justify-center space-x-2">
                      <div className="w-8 h-8 bg-[#40e0d0]/10 rounded-lg flex items-center justify-center">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-6 mt-8">
                <div className="relative">
                  <div className="bg-white p-4 sm:p-6 rounded-xl border border-[#40e0d0]/10 hover:border-[#40e0d0]/20 transition-colors shadow-sm hover:shadow-md duration-300">
                    <div className="flex flex-col items-center sm:items-start">
                      <div className="text-3xl sm:text-4xl font-merriweather font-bold text-[#003366] mb-1">500+</div>
                ...
                <div className="relative">
                  <div className="bg-white p-4 sm:p-6 rounded-xl border border-[#40e0d0]/10 hover:border-[#40e0d0]/20 transition-colors shadow-sm hover:shadow-md duration-300">
                    <div className="flex flex-col items-center sm:items-start">
                      <div className="text-3xl sm:text-4xl font-merriweather font-bold text-[#003366] mb-1">47</div>
                ...
                <div className="relative">
                  <div className="bg-white p-4 sm:p-6 rounded-xl border border-[#40e0d0]/10 hover:border-[#40e0d0]/20 transition-colors shadow-sm hover:shadow-md duration-300">
                    <div className="flex flex-col items-center sm:items-start">
                      <div className="text-3xl sm:text-4xl font-merriweather font-bold text-[#003366] mb-1">20+</div>
                  ...
                  <div key={index} className="group relative">
                    <div className="relative overflow-hidden rounded-xl bg-white border border-[#40e0d0]/10 hover:border-[#40e0d0]/20 transition-all duration-300">
                      <div className="aspect-square overflow-hidden">
                        ...
                        />
                        <div className="absolute inset-0 bg-[#003366]/30 opacity-0 group-hover:opacity-100 transition-all duration-300" />
                      </div>
                      <div className="p-4 relative bg-white transform transition-transform duration-300 group-hover:-translate-y-2">
                        ...
                        <div className="absolute top-0 right-0 p-2 opacity-0 group-hover:opacity-100 transition-opacity">
                          <svg className="w-5 h-5 text-[#40e0d0]/50" fill="none" stroke="currentColor" viewBox="0 0 24 24">
