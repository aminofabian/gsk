const Partners = () => {
  ...
  return (
    <section className="relative py-20 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-[#40e0d0]/5 via-white to-[#003366]/5" />
      ...
      <div className="max-w-7xl mx-auto px-4 relative">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-merriweather font-bold bg-gradient-to-r from-[#003366] via-[#40e0d0] to-[#003366] bg-clip-text text-transparent inline-block">
            GSK Network & Leadership
          </h2>
          <div className="w-20 h-1 bg-gradient-to-r from-[#003366] via-[#40e0d0] to-[#003366] mx-auto mt-4 rounded-full" />
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-stretch">
          ...
          <div className="flex flex-col h-full">
            <div className="bg-white rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 flex-1 flex flex-col">
              ...
              <div className="relative aspect-[4/3] bg-gradient-to-br from-[#003366] via-[#004080] to-[#40e0d0] rounded-xl overflow-hidden shadow-lg group flex-shrink-0">
                {/* Background Pattern */}
                    ...
                    <div className="absolute inset-0">
                      ...
                      <div className="absolute top-[55%] left-[48%] transform -translate-x-1/2 -translate-y-1/2">
                        <div className="relative">
                          <div className="w-6 h-6 rotate-45 bg-[#40e0d0] rounded-sm animate-pulse">
                      ...
                      <div className="absolute top-[65%] left-[68%] transform -translate-x-1/2 -translate-y-1/2">
                        <div className="w-4 h-4 rotate-45 bg-[#40e0d0]/70 rounded-sm animate-pulse" style={{ animationDelay: '0.5s' }}>
                          <div className="absolute inset-0 flex items-center justify-center -rotate-45">
                      ...
                      <div className="absolute top-[45%] left-[28%] transform -translate-x-1/2 -translate-y-1/2">
                        <div className="w-4 h-4 rotate-45 bg-[#40e0d0]/70 rounded-sm animate-pulse" style={{ animationDelay: '1s' }}>
                          <div className="absolute inset-0 flex items-center justify-center -rotate-45">
                            <span className="text-[#003366] text-[10px] font-bold">+</span>
                          </div>
                        </div>
                ...
                <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-gradient-to-b from-[#003366]/80 via-[#004080]/80 to-[#40e0d0]/80">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-6 mt-8">
                <div className="relative group">
                  <div className="absolute inset-0 bg-gradient-to-r from-[#003366] to-[#40e0d0] rounded-xl blur-lg opacity-20 group-hover:opacity-30 transition-opacity" />
                  <div className="relative bg-white p-4 sm:p-6 rounded-xl border border-[#40e0d0]/10 hover:border-[#40e0d0]/20 transition-colors shadow-sm hover:shadow-md duration-300">
                    <div className="flex flex-col items-center sm:items-start">
                      <div className="text-3xl sm:text-4xl font-merriweather font-bold bg-gradient-to-r from-[#003366] to-[#40e0d0] bg-clip-text text-transparent mb-1">500+</div>
                ...
                <div className="relative group">
                  ...
                  <div className="relative bg-white p-4 sm:p-6 rounded-xl border border-[#40e0d0]/10 hover:border-[#40e0d0]/20 transition-colors shadow-sm hover:shadow-md duration-300">
                    <div className="flex flex-col items-center sm:items-start">
                      <div className="text-3xl sm:text-4xl font-merriweather font-bold bg-gradient-to-r from-[#003366] to-[#40e0d0] bg-clip-text text-transparent mb-1">47</div>
                ...
                <div className="relative group">
                  ...
                  <div className="relative bg-white p-4 sm:p-6 rounded-xl border border-[#40e0d0]/10 hover:border-[#40e0d0]/20 transition-colors shadow-sm hover:shadow-md duration-300">
                    <div className="flex flex-col items-center sm:items-start">
                      <div className="text-3xl sm:text-4xl font-merriweather font-bold bg-gradient-to-r from-[#003366] to-[#40e0d0] bg-clip-text text-transparent mb-1">20+</div>
              ...
              <div className="grid grid-cols-2 gap-6 flex-1">
                {leaders.map((leader, index) => (
                  <div key={index} className="group relative">
                    <div className="absolute inset-0 bg-gradient-to-r from-[#003366] to-[#40e0d0] rounded-xl blur-lg opacity-0 group-hover:opacity-20 transition-all duration-300" />
                    <div className="relative overflow-hidden rounded-xl bg-white border border-[#40e0d0]/10 hover:border-[#40e0d0]/20 transition-all duration-300">
                      ...
                      <div className="p-4 relative bg-white transform transition-transform duration-300 group-hover:-translate-y-2">
                        ...
                        <p className="font-merriweather text-[#40e0d0]">{leader.title}</p>
                        <div className="mt-2 pt-2 border-t border-[#40e0d0]/10">
                        ...
                        <div className="absolute top-0 right-0 p-2 opacity-0 group-hover:opacity-100 transition-opacity">
                          <svg className="w-5 h-5 text-[#40e0d0]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
