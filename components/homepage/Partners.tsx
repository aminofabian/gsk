        ...
        <div className="grid lg:grid-cols-2 gap-16 items-stretch">
          ...
          <div className="flex flex-col h-full">
            <div className="bg-white rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 flex-1 flex flex-col">
              <h3 className="text-2xl font-bold text-blue-900 mb-4">GSK Member Network</h3>
              ...
              <div className="relative aspect-[4/3] bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900 rounded-xl overflow-hidden shadow-lg group flex-shrink-0">
                {/* Background Pattern */}
                ...
                <div className="absolute inset-0 flex items-center justify-center p-6">
                  <div className="relative w-full h-full">
                    {/* Glowing Effect */}
                    <div className="absolute inset-0 bg-blue-500/20 blur-3xl rounded-full scale-90 animate-pulse" />
                    
                    {/* Map Image */}
                    <img 
                      src="/leaders/kenya.png"
                      alt="Kenya Map"
                    ...
                    <div className="absolute inset-0">
                      ...
                      <div className="absolute top-[55%] left-[48%] transform -translate-x-1/2 -translate-y-1/2">
                        <div className="relative">
                          <div className="w-6 h-6 rotate-45 bg-white/90 rounded-sm animate-pulse">
                            <div className="absolute inset-0 flex items-center justify-center -rotate-45">
                              <span className="text-blue-900 text-xs font-bold">+</span>
                            </div>
                          </div>
                          <div className="absolute -bottom-6 left-1/2 transform -translate-x-1/2 whitespace-nowrap">
                            <span className="text-white text-xs font-semibold bg-blue-900/70 px-2 py-0.5 rounded">Nairobi</span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="absolute top-[65%] left-[68%] transform -translate-x-1/2 -translate-y-1/2">
                        <div className="w-4 h-4 rotate-45 bg-white/70 rounded-sm animate-pulse" style={{ animationDelay: '0.5s' }}>
                          <div className="absolute inset-0 flex items-center justify-center -rotate-45">
                            <span className="text-blue-900 text-[10px] font-bold">+</span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="absolute top-[45%] left-[28%] transform -translate-x-1/2 -translate-y-1/2">
                        <div className="w-4 h-4 rotate-45 bg-white/70 rounded-sm animate-pulse" style={{ animationDelay: '1s' }}>
                          <div className="absolute inset-0 flex items-center justify-center -rotate-45">
                            <span className="text-blue-900 text-[10px] font-bold">+</span>
                          </div>
                        </div>
                      ...
                      {/* Radar Scan Effect */}
                      <div className="absolute top-[55%] left-[48%] transform -translate-x-1/2 -translate-y-1/2">
                        <div className="w-40 h-40 border-2 border-white/10 rounded-full animate-ping opacity-20" />
                        <div className="absolute top-1/2 left-1/2 w-60 h-60 -translate-x-1/2 -translate-y-1/2 border border-white/5 rounded-full animate-ping opacity-10" style={{ animationDelay: '0.5s' }} />
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-gradient-to-b from-blue-900/80 via-blue-800/80 to-blue-900/80">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-6 mt-8">
                <div className="relative group">
                  ...
                  <div className="relative bg-white p-4 sm:p-6 rounded-xl border border-[#003366]/10 hover:border-[#003366]/20 transition-colors shadow-sm hover:shadow-md duration-300">
                    <div className="flex flex-col items-center sm:items-start">
                      <div className="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-[#003366] to-[#002244] bg-clip-text text-transparent mb-1">500+</div>
                      <div className="text-sm font-medium text-[#003366]/80">Active Members</div>
                    </div>
                ...
                <div className="relative group">
                  ...
                  <div className="relative bg-white p-4 sm:p-6 rounded-xl border border-[#003366]/10 hover:border-[#003366]/20 transition-colors shadow-sm hover:shadow-md duration-300">
                    <div className="flex flex-col items-center sm:items-start">
                      <div className="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-[#003366] to-[#002244] bg-clip-text text-transparent mb-1">47</div>
                      <div className="text-sm font-medium text-[#003366]/80">Counties Covered</div>
                    </div>
                    <div className="absolute top-0 right-0 p-2 opacity-10">
                      <svg className="w-8 h-8 text-[#003366]" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div className="relative group">
                  ...
                  <div className="relative bg-white p-4 sm:p-6 rounded-xl border border-[#003366]/10 hover:border-[#003366]/20 transition-colors shadow-sm hover:shadow-md duration-300">
                    <div className="flex flex-col items-center sm:items-start">
                      <div className="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-[#003366] to-[#002244] bg-clip-text text-transparent mb-1">20+</div>
                      <div className="text-sm font-medium text-[#003366]/80">Partners</div>
                    </div>
                    <div className="absolute top-0 right-0 p-2 opacity-10">
                      <svg className="w-8 h-8 text-[#003366]" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="flex flex-col h-full">
            <div className="bg-white rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 flex-1 flex flex-col">
              <h3 className="text-2xl font-bold text-blue-900 mb-8">Meet GSK's Partners</h3>
              <div className="grid grid-cols-2 gap-6 flex-1">
                {leaders.map((leader, index) => (
                  <div key={index} className="group relative">
                    <div className="absolute inset-0 bg-gradient-to-r from-blue-600 to-blue-800 rounded-xl blur-lg opacity-0 group-hover:opacity-20 transition-all duration-300" />
                    <div className="relative overflow-hidden rounded-xl bg-white border border-blue-100 hover:border-blue-200 transition-all duration-300">
                      ...
                      <div className="p-4 relative bg-white transform transition-transform duration-300 group-hover:-translate-y-2">
                        <h4 className="font-semibold text-lg text-blue-900">{leader.name}</h4>
