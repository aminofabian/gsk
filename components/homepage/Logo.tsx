    ...
    <Link href="/" className="hover:opacity-90 transition-opacity">
      <div className="flex items-center gap-4 sm:gap-6">
        <div className="relative w-14 h-14 sm:w-16 sm:h-16 flex-shrink-0">
          <div className="absolute inset-0  bg-gradient-to-br from-[#003366] to-[#002244] p-[3px] shadow-lg">
            <div className="h-full w-full  bg-white flex items-center justify-center overflow-hidden">
              <div className="relative flex items-center justify-center w-full h-full">
                <div className="absolute w-14 h-14 border-[4px] border-[#003366]  opacity-90"></div>
                <div className="absolute w-14 h-14 border-[4px] border-[#003366]  transform rotate-45 opacity-80"></div>
                <div className="absolute w-14 h-14 border-[4px] border-[#002244]  transform -rotate-45 opacity-70"></div>
