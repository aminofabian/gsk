      ...
      <div className="max-w-7xl mx-auto px-4 relative">
        ...
        >
          <div className="relative inline-block mb-8">
            <div className="absolute -inset-1 bg-gradient-to-r from-[#003366] via-[#004080] to-[#003366] rounded-lg blur opacity-20" />
            <h2 className="relative font-serif text-6xl md:text-7xl font-bold text-[#003366]">
              Medical Journal
            </h2>
            <div className="absolute -bottom-4 left-1/2 transform -translate-x-1/2 w-24 h-1 bg-[#003366]" />
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 relative">
          {publications.map((pub, index) => (
            ...
            >
              ...
              <div className="relative bg-white/95 backdrop-blur-sm rounded-[2rem] overflow-hidden border border-gray-100 shadow-lg">
                {/* Journal Header */}
                <div className="px-8 py-6 border-b border-gray-100">
                  <div className="flex items-center justify-between mb-4">
                    <span className="px-4 py-1.5 bg-[#003366]/5 text-[#003366] text-sm font-medium rounded-full">
                      {pub.category}
                    </span>
                  ...
                  <h3 className="text-2xl font-serif font-bold text-[#003366] mb-3">
                    {pub.title}
                  </h3>
                ...
                <div className="relative">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-8">
                    <div className="text-white mb-4 line-clamp-2 font-serif">
                      <FaQuoteRight className="float-left mr-4 text-3xl opacity-50" />
                      {pub.preview}
                    </div>
                  </div>
                </div>
                ...
                <div className="p-8 border-t border-gray-100">
                  <div className="flex flex-wrap gap-2 mb-6">
                    {pub.tags.map((tag, tagIndex) => (
                      <span 
                        key={tagIndex}
                        className="px-3 py-1 bg-[#003366]/5 text-[#003366] text-sm font-serif rounded-full hover:bg-[#003366]/10 transition-colors cursor-pointer"
                      >
                        #{tag}
                      </span>
                    ))}
                  ...
                  <motion.button 
                    className="group w-full flex items-center justify-center gap-2 px-6 py-3 bg-[#003366] text-white rounded-full hover:bg-[#004488] transition-all"
        ...
        >
          <motion.button 
            className="group relative inline-flex items-center gap-3 px-10 py-5 bg-[#003366] text-white rounded-full text-lg font-serif hover:bg-[#004488] transition-all overflow-hidden shadow-lg"
          ...
          >
            ...
            <motion.div
              className="absolute inset-0 bg-gradient-to-r from-[#003366] via-[#004488] to-[#003366]"
              animate={{
