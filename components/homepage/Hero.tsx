            ...
            <div className="max-w-7xl mx-auto">
              <div className="max-w-3xl">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <a 
                    href="/membership"
                    className="inline-flex justify-center items-center px-8 py-3 bg-[#FF6B35] text-white rounded-lg font-semibold hover:bg-[#FF6B35]/90 transition-all duration-300 text-lg shadow-lg"
                  >
                    Become a Member
                  </a>
                  <a 
