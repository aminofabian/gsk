    ...
    <>
      <div className="absolute inset-0 bg-gradient-to-br from-[#003366] via-[#004488] to-[#003366] overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-30">
          ...
          <div className="absolute top-1/2 right-0 w-96 h-96 bg-purple-400 rounded-full mix-blend-multiply filter blur-xl animate-blob animation-delay-2000"></div>
          <div className="absolute bottom-0 left-1/4 w-96 h-96 bg-pink-400 rounded-full mix-blend-multiply filter blur-xl animate-blob animation-delay-4000"></div>
        </div>
