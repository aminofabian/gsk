      ...
      <div>
            ...
            <form className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select className="w-full px-4 py-2 rounded-lg border border-gray-200 focus:border-[#003366] focus:ring-1 focus:ring-[#003366]">
        ...
        <div className="space-y-4">
          {news.map((article) => (
            <div
              key={article.id}
              className="p-6 bg-white rounded-xl border hover:shadow-sm transition-shadow"
            >
